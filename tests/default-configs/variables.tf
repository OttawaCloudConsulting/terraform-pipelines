...
variable "configs_repo" {
  description = "GitHub repository in org/repo format for the configs repo"
  type        = string
}

variable "configs_repo_branch" {
  description = "Branch of the configs repo"
  type        = string
  default     = "main"
}

variable "configs_repo_path" {
  description = "Path within the configs repo to the environments/ directory"
  type        = string
  default     = "."
}
